...
1. What is the DOM?
DOM connects web pages from memory.

2. What is an event?
Event is when something interesting happens to the code. 
3. What is an event listener?
Event Listener is when that event listens to a movement or something done to the page before taking action. 
4. Why would we convert a NodeList into an Array?
We need to convert it when we want to use the .forEach method.
5. What is a component?
They are resuable pieces of code that can be used to build elements.
